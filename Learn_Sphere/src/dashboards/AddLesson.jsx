...
function AddLesson( { instructorList, prerequisiteOptions }) {
    ...
    {
        e.preventDefault();
        console.log(lesson.lessonId, lesson.title, lesson.description, readingList, prerequisites, [], lesson.creditPoints, lesson.instructor, lesson.status);
        addLessonToDatabase(lesson.lessonId, lesson.title, lesson.description, readingList, prerequisites, [], lesson.creditPoints, lesson.instructor, lesson.status);
    };
